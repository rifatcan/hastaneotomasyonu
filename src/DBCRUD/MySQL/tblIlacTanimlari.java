 ...
 * @author rbarka
 */
public class tblIlacTanimlari implements ICRUD{
    allConnections baglanti = new allConnections();
    
    @Override
    public void Kaydet(Object o) {
        try {
            PreparedStatement  ifade = baglanti.baglan().prepareCall("insert into tblilac_tanimlari(id,ilac_adi,doz) values('3','Voltaren','Günde 1 Defa')");
            ifade.executeUpdate();
    ...
    public static void main(String[] args) {
        tblIlacTanimlari ilac = new tblIlacTanimlari();
        ilac.Kaydet("");
    }
